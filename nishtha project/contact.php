...
if(isset($_POST['submit']))
{
  if($_POST['uname']=="" || $_POST['password']=="")
  {
    ...
    $d=mysqli_query($con,"SELECT * FROM loginform where uname='{$_POST['uname']}'");
    $row=mysqli_fetch_object($d);
    $funame=$row->uname;
    $fpassword=$row->password;
    if($funame==$_POST['uname'] && $fpassword==$_POST['password'])
    {
...
<form id="regForm" method="post">
  ...
  <div style="overflow:auto;">
    ...
    <br>  <br> <br><p style="color:white;"> Don't have an account? <a href="signup.php" style="font-family:play,sans-serif; color:red;"> &nbsp; sign up</a>
  </div>
